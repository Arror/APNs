...
public class ProductionTokenListView: TokenListView, NSTableViewDelegate, NSTableViewDataSource {
    
    public override var controller: TokenListController {
        return self._controller
    }
    
    private let _controller = TokenListController(server: .production)
